...
//
// NOTE: disabling this disabled the checkmark in checked 
// checkboxes.
...
#define LV_FONT_CUSTOM_DECLARE \
    LV_FONT_DECLARE(font_montserrat_alphanum_12) \
    LV_FONT_DECLARE(font_montserrat_alphanum_16) \
    LV_FONT_DECLARE(font_montserrat_alphanum_20) \
    LV_FONT_DECLARE(font_montserrat_numeric_20) \
    LV_FONT_DECLARE(font_montserrat_numeric_50) \
    LV_FONT_DECLARE(font_fa_symbols_28)
...
// NOTE: the small font here is used to draw the default checkmak
// in checkboxes.
#define LV_THEME_DEFAULT_FONT_SMALL         &font_montserrat_alphanum_20
#define LV_THEME_DEFAULT_FONT_NORMAL        &font_montserrat_alphanum_20
#define LV_THEME_DEFAULT_FONT_SUBTITLE      &font_montserrat_alphanum_20
#define LV_THEME_DEFAULT_FONT_TITLE         &font_montserrat_alphanum_20
