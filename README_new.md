...
NOTE: The design of the Simple Stepper Motor analyzer was upgraded to a Raspberry Pi Pico based single board form factor. The  dual board STM32 legacy design 
was moved to https://github.com/zapta/simple_stepper_motor_analyzer.</b></span>
