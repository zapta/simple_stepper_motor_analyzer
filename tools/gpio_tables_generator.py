# A python program to generate the gpio tables in display/gpio_tables.cpp.
#
# Usage: run with no arguments, paste the output to display/gpio_tables.cc,
# and reformat the file.
#
# python gpio_tables_generator.py
#
